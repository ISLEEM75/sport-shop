                ...
                <ul>
                    ...
                    <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
                        ...
                        <div class="tp-caption font-playfair sfb tp-resizeme"
                             ...
                             data-endspeed="300"
                             style="z-index: 7; font-size:18px; color:#fff; max-width: auto; max-height: auto; white-space: nowrap;">All World Cup shirts from ISLEEM</div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption sfl font-extra-bold tp-resizeme"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="300"
                             style="z-index: 6; font-size:80px; color:#2d3a4b; text-transform:uppercase; white-space: nowrap;"><small class="font-regular">$</small>50 </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption sfr font-extra-bold tp-resizeme"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="300"
                             style="z-index: 6; font-size:120px; color:#fff; text-transform:uppercase; white-space: nowrap;">the original </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption sfr font-extra-bold tp-resizeme"
                             data-x="left" data-hoffset="0"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="300"
                             style="z-index: 6; font-size:120px; color:#fff; text-transform:uppercase; white-space: nowrap;">football </div>
                        <!-- LAYER NR. 4 -->
                    ...
                    <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
                        ...
                        <div class="tp-caption font-playfair sfb tp-resizeme"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="300"
                             style="z-index: 7; font-size:18px; color:#fff; max-width: auto; max-height: auto; white-space: nowrap;">The Latest Product from NIKE</div>
                        <!-- LAYER NR. 2 -->
                        ...
                        <div class="tp-caption sfb font-extra-bold tp-resizeme"
                             ...
                             data-endelementdelay="0.1"
                             data-endspeed="300"
                             style="z-index: 6; font-size:60px; color:#fff; text-transform:uppercase; white-space: nowrap;"><small class="font-regular">$</small> 70 </div>
                        <!-- LAYER NR. 4 -->
        ...
        <section class="padding-top-100 padding-bottom-100">
          ...
          Sed feugiat, tellus vel tristique posuere, diam</span> </div>
            ...
            <div class="arrival-block">
                ...
                <div class="item">
                    <!-- Images -->
                    <img class="img-1" src="/images/{{$product->image}}" alt=""> <img class="img-2" src="/images/{{$product->image}}" alt="">
                    <!-- Overlay  -->
                    <div class="overlay">
                        <!-- Price -->
                        <span class="price"><small>$</small>{{$product->price}}</span>
                        <div class="position-center-center"> <a href="/images/{{$product->image}}" data-lighter><i class="icon-magnifier"></i></a> </div>
                    </div>
                    <!-- Item Name -->
